...
pub fn render_menu(
    ...
    is_admin: bool, // Added flag for privilege
    ...
    CentralPanel::default().show(ctx, |ui| {
        ...
        // Adding stoplight indicator
        let stoplight_color = if is_admin { GREEN } else { RED };
        Area::new(Id::new("stoplight_indicator"))
            .anchor(Align2::CENTER_BOTTOM, (0.0, -20.0))
            .show(&ui.ctx(), |ui| {
                ui.colored_label(stoplight_color, "●");
            });
